...
float3 get_atm(float3 view, float3 sun_direction)
{
	return atmosphere(
		view,								// normalized ray direction
		float3(0, 6372e3 - 460, 0),			// ray origin
		sun_direction,						// position of the sun
		22.0,								// intensity of the sun
		6371e3,								// radius of the planet in meters
		6471e3,								// radius of the atmosphere in meters
		float3(5.5e-6, 13.0e-6, 22.4e-6),	// Rayleigh scattering coefficient
		3 * 0.08 * 21e-6,					// Mie scattering coefficient
		8e3,								// Rayleigh scale height
		2e3,								// Mie scale height
		0.9778f								// Mie preferred scattering direction
	);
}

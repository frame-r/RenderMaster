...
DX11Texture::DX11Texture(ID3D11Resource *pResourceIn, ID3D11ShaderResourceView * pShaderViewIn, ID3D11RenderTargetView * pRendertargetView, ID3D11DepthStencilView *pDepthStencilView, TEXTURE_FORMAT formatIn)
 : _resource(pResourceIn), _shaderView(pShaderViewIn), _renderTargetView(pRendertargetView), _depthStencilView(pDepthStencilView), _format(formatIn)
{

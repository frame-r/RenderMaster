...
public:
	...
	DX11Texture(ID3D11Resource* pResourceIn, ID3D11ShaderResourceView* pShaderViewIn, ID3D11RenderTargetView *pRendertargetView, ID3D11DepthStencilView *pDepthStencilView, TEXTURE_FORMAT formatIn);
	virtual ~DX11Texture();

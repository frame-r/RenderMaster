	...
	_mousePressTitleWidget(NULL)
{
	...
	_tabsScrollArea->setFixedHeight(15);
	...
	//_tabsContainerWidget->setFixedHeight(25);
	...
	_tabsLayout->setSpacing(10);
	_tabsLayout->setMargin(7);
...
//	_topLayout->addWidget(_tabsMenuButton, 0);
	...
	_closeButton->setIconSize({13, 13});
	_closeButton->setStyleSheet("padding: 2px -2px 2px 2px;");
	_closeButton->setBackgroundRole(QPalette::HighlightedText);
	_closeButton->setAutoFillBackground(true);
